...
class Controller implements ContainerAwareInterface
{
     ...
     * @param Array $metadata This provides a map of what the default pagination parameters are to be called, by default they are "page" (as in page number) and "page_size" (records par page_
